...
const MILESTONES: Milestone[] = [
  {
    ...
    description: "Build the core Prajvaya digital platform and grow our early coordinator community circles.",
    status: "completed",
  },
  {
    step: "02",
    title: "Phase 2: Knowledge Access",
    description: "Launch the Wisdom Library and release practical, interactive educational content.",
    status: "active",
  },
  {
    step: "03",
    title: "Phase 3: Empathetic AI",
    description: "Launch the AI Companion with secure, private, and empathetic daily alignment conversations inspired by Indian wisdom.",
    status: "planned",
  },
  {
    step: "04",
    title: "Phase 4: Lifespace Integration",
    description: "Expand our features into guided systems learning, home sustainability tools, and circular wellness experiences.",
    status: "planned",
  },
  {
    step: "05",
    title: "Phase 5: Global Ecosystem",
    description: "Establish a worldwide ecosystem where technology helps people reconnect with wisdom, purpose, community, and nature.",
    status: "planned",
  },
];
